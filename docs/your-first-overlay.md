...
- **Selected-indicator alignment** — [docs/selected-indicator-pattern.md](./selected-indicator-pattern.md): the `[forceMount]` + `opacity` pattern for keeping checkmarks visually aligned in Select, Combobox, and Menu.
