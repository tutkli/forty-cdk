...
export const routes: Routes = [
  ...
  {
    path: 'combobox-scroll',
    loadComponent: () =>
      import('./fixtures/combobox-scroll.fixture').then((m) => m.ComboboxScrollFixture),
  },
  {
    path: 'otp-input',
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./fixtures/date-range-field.fixture').then((m) => m.DateRangeFieldFixture),
  },
  {
    path: 'time-field',
  ...
  {
    path: 'table-perf-virtualized',
    loadComponent: () =>
      import('./fixtures/table-perf-virtualized.fixture').then(
        (m) => m.TablePerfVirtualizedFixture,
      ),
  },
  {
  ...
  {
    path: 'for-table-body-virtualized',
    loadComponent: () =>
      import('./fixtures/for-table-body-virtualized.fixture').then(
        (m) => m.ForTableBodyVirtualizedFixture,
      ),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./fixtures/for-table-body-variants.fixture').then(
        (m) => m.ForTableBodyVariantsFixture,
      ),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./fixtures/for-table-body-variants-virtualized.fixture').then(
        (m) => m.ForTableBodyVariantsVirtualizedFixture,
      ),
  },
  {
  ...
  {
    path: 'virtual-reorder',
    loadComponent: () =>
      import('./fixtures/virtual-reorder.fixture').then((m) => m.VirtualReorderFixture),
  },
  {
