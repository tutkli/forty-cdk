...
export const PLAYGROUND_GROUPS: readonly PlaygroundGroup[] = [
  ...
  },
  {
    ...
    primitives: [
      ...
      { slug: 'checkbox', title: 'Checkbox', ready: false },
      { slug: 'toggle', title: 'Toggle', ready: false },
      { slug: 'radio-group', title: 'Radio Group', ready: false },
      { slug: 'slider', title: 'Slider', ready: false },
