...
@Component({
  ...
  template: `
    <playground-demo
      title="Dropdown Menu"
      summary="A button-triggered menu positioned by floating-ui, with full keyboard support: arrows move between items, typeahead jumps to a label, Home/End reach the ends. It dismisses on Escape, outside pointer-down and Tab, returning focus to the trigger. The surface is portaled to <body>, so its styles live in styles.css."
