...
@Component({
  ...
  template: `
    <playground-demo
      ...
      subtitle="A menu opened by right-click (or Shift+F10 / the Menu key when the region is focused), anchored to the pointer through a virtual element. It shares the menu vocabulary and keyboard model with the Dropdown Menu, dismissing on Escape, outside pointer-down and Tab. The surface is portaled to <body>."
      sourcePath="projects/forty-cdk-playground/src/app/demos/context-menu/examples/context-menu.example.ts"
    >
