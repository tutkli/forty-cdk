...
@Component({
  ...
  template: `
    <playground-demo
      title="Toolbar"
      summary="A container for grouped controls that shares one tab stop. Tab in, then move across every button, toggle and link with the arrow keys, Home and End — nested ToggleGroups join the same roving sequence automatically."
