...
@Component({
  ...
  template: `
    <playground-demo
      title="Aspect Ratio"
      summary="A layout utility that locks a box to a width / height ratio. It only sets the CSS aspect-ratio property on its host — no ARIA, no behavior. The content scales fluidly with the available width."
    >
