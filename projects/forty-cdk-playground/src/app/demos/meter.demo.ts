...
@Component({
  ...
  template: `
    <playground-demo
      title="Meter"
      summary="A scalar measurement inside a known range — think battery, disk or a score. Unlike Progress it is not about a task finishing: it reflects data-quality (optimum / sub-optimum / even-less-good) from the low / high / optimum thresholds."
