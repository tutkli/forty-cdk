...
@Component({
  ...
  template: `
    <playground-demo
      title="Hover Card"
      summary="A rich preview that opens when the pointer rests on the trigger and stays open while the pointer is inside the card, so its content can be interactive. Keyboard focus opens it too and Escape closes it. The card is portaled to <body>."
    >
