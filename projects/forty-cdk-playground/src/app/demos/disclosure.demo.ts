...
@Component({
  ...
  template: `
    <playground-demo
      title="Disclosure"
      summary="A single show/hide section — the building block behind Accordion. The panel stays mounted while closed (the directive marks it aria-hidden + inert), so it can animate open with pure CSS instead of being unmounted."
