...
@Component({
  ...
  template: `
    <playground-demo
      title="Progress"
      summary="A determinate or indeterminate progress bar. The directive exposes the live percentage as a CSS custom property and reflects data-state (loading → complete); switching value to null enters indeterminate mode."
