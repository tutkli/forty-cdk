...
@Component({
  ...
  template: `
    <playground-demo
      ...
      subtitle="Native scrolling with custom-styled scrollbars. The directive hides the platform bars and paints synthetic ones whose thumb size and position track the real scroll. The content overflows on both axes, so the corner fills the gap."
      sourcePath="projects/forty-cdk-playground/src/app/demos/scroll-area/examples/scroll-area.example.ts"
    >
...
export class ScrollAreaExample {
