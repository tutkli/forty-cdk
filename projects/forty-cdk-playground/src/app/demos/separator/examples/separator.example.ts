...
@Component({
  ...
  template: `
    <playground-demo
      ...
      subtitle="A decorative or semantic divider, plus a focusable resizer variant. Focus the bar between the panes and drag it, or use the arrow keys, PageUp / PageDown and Home / End to resize."
