  ...
  template: `
    <primitive-page slug="drawer" [doc]="doc">
      ...
      <demo-layout
        ...
        sourcePath="drawer/examples/snap-points.example.ts"
      >
      ...
      <demo-layout
        ...
        subtitle="With <code>[scaleBackground]</code> the <code>[forDrawerWrapper]</code> element scales and rounds its corners behind the drawer, so the page reads as a layer that recedes. Here the wrapper is the app shell of this documentation site, so the whole page recedes behind the sheet."
      ...
      <demo-layout
        ...
        sourcePath="drawer/examples/nested.example.ts"
      >
