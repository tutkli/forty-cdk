...
@Component({
  selector: 'app-carousel-multiple-slides-example',
  ...
  template: `
    ...
    >
      <div class="mcar-nav-row">
        <button forCarouselPrevious class="mcar-btn" aria-label="Previous slide">
        ...
        <button forCarouselNext class="mcar-btn" aria-label="Next slide">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <path
  ...
  styles: `
    ...
    .mcar-btn:hover:not([data-disabled]) {
      background: var(--pg-surface-2);
    }

    .mcar-btn[data-disabled] {
      opacity: 0.4;
      cursor: not-allowed;
    }
    ...
    .mcar-slide {
      flex: 0 0
        calc(
          (100% - 0.5rem * (var(--for-carousel-slides-per-view) - 1)) /
