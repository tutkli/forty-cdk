 ...
 * `[forTimeRangeFieldStart]` / `[forTimeRangeFieldEnd]` endpoint. Apply on the
 ...
 */
@Directive({
  selector: '[forTimeRangeFieldLiteral]',
  exportAs: 'forTimeRangeFieldLiteral',
})
export class ForTimeRangeFieldLiteral extends ForDateTimeLiteralBase {}
