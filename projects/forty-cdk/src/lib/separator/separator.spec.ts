...
describe('ForSeparator', () => {
  describe('semantic mode (default)', () => {
    ...
    it('does not expose aria-value* / tabindex by default', () => {
      const { query } = renderHost(SeparatorHost);
      const el = query<HTMLElement>('[forSeparator]')!;
  ...
  describe('focusable variant — ARIA', () => {
    it('exposes tabindex, aria-orientation, and aria-value*', () => {
      const { query } = renderHost(FocusableSeparatorHost);
      const el = query<HTMLElement>('[forSeparator]')!;
    ...
    it('reflects aria-orientation="horizontal" explicitly in the focusable variant', () => {
  ...
  describe('focusable variant — keyboard (vertical separator, LTR)', () => {
  ...
  describe('focusable variant — keyboard (vertical separator, RTL)', () => {
  ...
  describe('focusable variant — keyboard (horizontal separator)', () => {
  ...
  describe('focusable variant — collapsible', () => {
  ...
  describe('focusable variant — disabled', () => {
  ...
  describe('focusable variant — pointer drag', () => {
  ...
  describe('zoneless reactivity', () => {
    ...
    it('focusable variant reflects aria-value* under provideZonelessChangeDetection', () => {
      TestBed.configureTestingModule({
        providers: [provideZonelessChangeDetection()],
      });
      ...
      @Component({
        imports: [ForSeparator],
        template: `<div forSeparator focusable [value]="v()" [min]="0" [max]="100"></div>`,
      })
      class Host {
